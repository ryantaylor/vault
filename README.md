...
[![crates.io](https://img.shields.io/crates/v/vault.svg)](https://crates.io/crates/vault) [![Documentation](https://img.shields.io/badge/View-Documentation-blue.svg)](https://docs.rs/vault/7.0.0/vault/)
...
```toml
[dependencies]
vault = { version = "7", features = ["magnus"] }
```
...
```toml
[dependencies]
vault = { version = "7", features = ["serde"] }
```
...
Documentation for `vault` [can be viewed online](https://docs.rs/vault/7.0.0/vault/).
